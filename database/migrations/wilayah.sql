...
INSERT INTO `kabupaten` (`kabupaten_id`, `provinsi_id`, `nama`) VALUES
...
INSERT INTO `kecamatan` (`kecamatan_id`, `kabupaten_id`, `nama`) VALUES
...
--
ALTER TABLE `kabupaten`
  ADD CONSTRAINT `regencies_province_id_foreign` FOREIGN KEY (`provinsi_id`) REFERENCES `provinsi` (`provinsi_id`);

--
-- Constraints for table `kecamatan`
--
ALTER TABLE `kecamatan`
  ADD CONSTRAINT `districts_regency_id_foreign` FOREIGN KEY (`kabupaten_id`) REFERENCES `kabupaten` (`kabupaten_id`);
COMMIT;
